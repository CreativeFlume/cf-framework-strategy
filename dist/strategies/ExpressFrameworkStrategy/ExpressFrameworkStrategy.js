...
var ExpressFrameworkStrategy = (function (_BaseFrameworkStrateg) {
  ...
  function ExpressFrameworkStrategy(config) {
    ...
    _this.framework = require(BaseFrameworkStrategy.constants.EXPRESS);
  ...
  _createClass(ExpressFrameworkStrategy, [{
    ...
    value: function start() {
      ...
      var port = me.config.http && me.config.http.port || BaseFrameworkStrategy.constants.DEFAULT_PORT;
      ...
      return new Promise(function (resolve) {
        ...
        me.server = http.createServer(me.app).listen(port, function () {

          if (me.config.https && me.config.https.port) {

            me.httpsServer = https.createServer(me.config.https.options, me.app).listen(me.config.https.port, function () {
              superStart();
              resolve(me);
            });
          } else {
